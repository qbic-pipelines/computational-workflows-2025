...
opt <- list(
    abundance_matrix_file = 'salmon.merged.gene_counts.assay.tsv',
...
args_opt <- parse_args('--sample_id_col "sample" --minimum_samples 1.0 --minimum_abundance 1.0   --minimum_proportion_not_na "0.5"')
